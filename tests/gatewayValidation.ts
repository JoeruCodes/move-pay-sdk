...
import {validateSystemInstruction, validateCustomTokenTransfer} from "../src/gatewayValidation";
...
describe('test gateway validation functions', () => {
    test("test validateCustomTokenTransfer", async () => {
        ...
        validateCustomTokenTransfer(recipent.accountAddress, aptos, tokenMetadata, BigInt(1));
    })
