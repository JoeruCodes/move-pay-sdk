...
import { buildStandaloneQRcodeURL, petraQRConnect, petraQRConnectDApp } from "../src/wallet/petra";
...
describe('test generate QRCodes', () => {
  ...
  test('test qrcode normal', async () => {
    ...
    //   });
      ...
      const qrCodePayload = buildStandaloneQRcodeURL(recipient.accountAddress.toString());
      const qrCodeDataURL = await createQRCodeFromCDN(qrCodePayload.toString());
