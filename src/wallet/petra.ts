...
const APP_KEYPAIRS = {
  publicKey: new Uint8Array([
    ...
    82, 34, 195, 45, 92, 171, 120, 184, 33, 234, 90, 174, 101, 144, 16,
  ]),
  secretKey: new Uint8Array([
    123, 23, 220, 55, 147, 43, 116, 173, 72, 229, 20, 121, 215, 18, 145, 226,
    158, 210, 48, 131, 96, 228, 4, 186, 33, 127, 3, 4, 169, 88, 198, 66,
  ]),
};
...
export function petraQRConnectDApp(
  ...
  const data: LinkerPayloadInterface = {
    ...
    dappEncryptionPublicKey: Buffer.from(APP_KEYPAIRS.publicKey).toString(
      "hex",
    ),
  };
  const ret = new URL(
...
function getSharedEncryptionSecretKey(
  data: string,
...
export function signAndSumbitTransactionDapp(
